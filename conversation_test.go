...
func TestBuildMessageContentInlinesTextFilesWhenDirectFilesDisabled(t *testing.T) {
	...
	content, summary := buildMessageContent(node, messageContentOptions{
		maxImages:                0,
		allowAudio:               false,
		allowDocuments:           false,
		allowFiles:               false,
...
func TestBuildMessageContentFiltersUnsupportedMedia(t *testing.T) {
	...
	content, summary := buildMessageContent(node, textOnlyOptions)
	...
	content, summary = buildMessageContent(node, geminiOptions)
