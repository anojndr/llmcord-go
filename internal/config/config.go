...
const (
	// WebSearchProviderKindFreeweb is the freeweb browser provider.
...
// FreeWebSearchConfig holds freeweb settings.
...
// FreewebEnabled reports whether freeweb extraction is enabled.
