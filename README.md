...
- URLs that appear only inside attached-file content, such as `text/*` attachments or extracted PDF text, are not treated as user-supplied URLs for TikTok, YouTube, Reddit, or generic website fetching.
